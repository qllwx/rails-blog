...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference("Area.count") do
      post areas_url, params: { area: { code: @area.code, name: @area.name, total_shcools: @area.total_shcools } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { code: @area.code, name: @area.name, total_shcools: @area.total_shcools } }
